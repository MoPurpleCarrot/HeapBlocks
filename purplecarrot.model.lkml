...
explore: users {
  ...
  fields: [ALL_FIELDS*, -customer_issues.ab_one_time_exclusion,-customer_issues.primo_anomalies,-customer_issues.ab_anomalies,-customer_issues.gf_anomalies,-customer_issues.so_anomalies]
 ...
 join: flex_contract {
  ...
  join: flex_contract_shipments {
    relationship: one_to_one
    sql_on: ${flex_contract_shipments.shipment_id} = ${shipments.id} ;;
  }
...
explore: credit_transactions{
  label: "Order Credits"
  fields: [ALL_FIELDS*,-customer_issues.ab_one_time_exclusion, -customer_issues.primo_anomalies,-customer_issues.ab_anomalies,-customer_issues.gf_anomalies,-customer_issues.so_anomalies, -cx_rep_user.utm_source_groups, -users.utm_source_groups]
