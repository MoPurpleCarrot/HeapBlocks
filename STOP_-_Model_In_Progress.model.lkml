...
explore: users {
  persist_for: "1 hour"
  label: "Users Base"
  fields: [ALL_FIELDS*, -users.utm_source_groups,-customer_issues.ab_one_time_exclusion, -customer_issues.primo_anomalies,-customer_issues.ab_anomalies,-customer_issues.gf_anomalies,-customer_issues.so_anomalies]
