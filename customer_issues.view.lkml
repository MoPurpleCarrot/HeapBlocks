view: customer_issues {
  ...
  dimension: gf_anomalies {
    type: yesno
    sql: ${orders_data.ship_template_fulfillment_center}='Get_Fresh_Las_Vegas' and ((${reason}='Ingredient Substitution' and ${ingredients.ingredient_name}='almond milk' and ${menus.ship_week_mon_start_date}='2021/09/13') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='lime'and ${menus.ship_week_mon_start_date}='2021/10/25') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='tomato powder'and ${menus.ship_week_mon_start_date}='2021/10/25') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name} = ' raisins ' and ${menus.ship_week_mon_start_date}='2021/11/08') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name} = '*Not included' and ${menus.ship_week_mon_start_date}='2021/11/22')) ;;
  }
