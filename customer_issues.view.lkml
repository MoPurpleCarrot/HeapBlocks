view: customer_issues {
  ...
  dimension: ab_anomalies {
    type: yesno
    sql:${orders_data.ship_template_fulfillment_center}='AtomBanana_Chicago' and ((${reason}='Missing Booklet' and ${menus.ship_week_mon_start_date}='2021/08/09') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='vegan sour cream' and ${menus.ship_week_mon_start_date}='2021/07/26') or (${reason}='Ingredient Substitution' and ${ingredients.ingredient_name}='almond milk' and ${menus.ship_week_mon_start_date}='2021/09/13') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='vegan cabbage kimchi' and ${menus.ship_week_mon_start_date}='2021/09/06') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='peanut butter' and ${menus.ship_week_mon_start_date}='2021/08/23') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name} like 'Treeline%' and ${ingredients.ingredient_name} not like '%French-Style%' and ${menus.ship_week_mon_start_date}='2021/08/16') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='nutritional yeast' and ${menus.ship_week_mon_start_date}='2021/10/18') or (${reason}='Ingredient Substitution'and ${ingredients.ingredient_name}='nutritional yeast' and ${menus.ship_week_mon_start_date}='2021/10/18') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='potato buns'and ${menus.ship_week_mon_start_date}='2021/10/25') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='lime'and ${menus.ship_week_mon_start_date}='2021/10/25') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='tomato powder'and ${menus.ship_week_mon_start_date}='2021/10/25') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='cremini mushrooms' and ${menus.ship_week_mon_start_date}='2021/11/29')or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='ciabatta rolls' and ${menus.ship_week_mon_start_date}='2021/11/22')or(${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='artichoke hearts'and ${menus.ship_week_mon_start_date}='2021/12/6')or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='panang curry paste' and ${menus.ship_week_mon_start_date}='2022/02/14')or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='hearts of palm' and ${menus.ship_week_mon_start_date}='2022/02/14'));;
  }
  ...
  dimension: gf_anomalies {
    type: yesno
    sql: ${orders_data.ship_template_fulfillment_center}='Get_Fresh_Las_Vegas' and ((${reason}='Ingredient Substitution' and ${ingredients.ingredient_name}='almond milk' and ${menus.ship_week_mon_start_date}='2021/09/13') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='lime'and ${menus.ship_week_mon_start_date}='2021/10/25') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='tomato powder'and ${menus.ship_week_mon_start_date}='2021/10/25') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name} = ' raisins ' and ${menus.ship_week_mon_start_date}='2021/11/08') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name} = '*Not included' and ${menus.ship_week_mon_start_date}='2021/11/22') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name} = 'black beans' and ${menus.ship_week_mon_start_date}='2021/11/22')or(${reason}='Missing Ingredient' and ${ingredients.ingredient_name} = 'dried currants' and ${menus.ship_week_mon_start_date}='2021/12/6')or(${reason}='Missing Ingredient' and ${ingredients.ingredient_name} = 'radishes' and ${menus.ship_week_mon_start_date}='2022/3/7')) ;;
  }

  dimension: primo_anomalies {
    type: yesno
    sql: ${orders_data.ship_template_fulfillment_center}='Primo_Pennsylvania' and ((${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='tomato powder' and ${menus.ship_week_mon_start_date}='2021/10/25') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='lime'and ${menus.ship_week_mon_start_date}='2021/10/25') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='togarashi'and ${menus.ship_week_mon_start_date}='2021/11/01')or(${reason}='Missing Meal' and ${amount} = '153862' and ${user_id}=1618184) or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='cremini mushrooms'and ${menus.ship_week_mon_start_date}='2021/11/29')or(${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='Brussels sprouts'and ${menus.ship_week_mon_start_date}='2022/1/17') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='Forager Project® Organic Dairy-Free Cashewmilk Yogurt' and ${menus.ship_week_mon_start_date}='2022/2/28'))  ;;
  }

  dimension: all_anomalies {
    type: yesno
    sql: ${primo_anomalies}='yes' or ${gf_anomalies}='yes' or ${ab_anomalies}='yes';;
    }
