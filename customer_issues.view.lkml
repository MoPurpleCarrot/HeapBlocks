view: customer_issues {
  ...
  dimension: ab_anomalies {
    type: yesno
    sql: (${reason}='Missing Booklet' and ${menus.ship_week_mon_start_date}='2021/08/09' and ${orders_data.ship_template_fulfillment_center}='AtomBanana_Chicago') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='vegan sour cream' and ${menus.ship_week_mon_start_date}='2021/07/26' and ${orders_data.ship_template_fulfillment_center}='AtomBanana_Chicago') or (${reason}='Ingredient Substitution' and ${ingredients.ingredient_name}='almond milk' and ${menus.ship_week_mon_start_date}='2021/09/13' and ${orders_data.ship_template_fulfillment_center}='AtomBanana_Chicago') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='vegan cabbage kimchi' and ${menus.ship_week_mon_start_date}='2021/09/06' and ${orders_data.ship_template_fulfillment_center}='AtomBanana_Chicago') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='peanut butter' and ${menus.ship_week_mon_start_date}='2021/08/23' and ${orders_data.ship_template_fulfillment_center}='AtomBanana_Chicago') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name} like 'Treeline%' and ${ingredients.ingredient_name} not like '%French-Style%' and ${menus.ship_week_mon_start_date}='2021/08/16' and ${orders_data.ship_template_fulfillment_center}='AtomBanana_Chicago') or (${reason}='Missing Ingredient' and ${ingredients.ingredient_name}='nutritional yeast' and ${menus.ship_week_mon_start_date}='2021/10/18' and ${orders_data.ship_template_fulfillment_center}='AtomBanana_Chicago')  ;;
  }
